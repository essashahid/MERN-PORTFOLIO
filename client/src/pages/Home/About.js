        ...
        <div>
            ...
            <div className="flex w-full items-center">
                ...
                <p className="text-white">
                    ...
                    <p className="text-white">
                        I'm actively seeking Product Management internships or co-ops in the tech industry for Summer 2024, where I can apply my data-driven approach to deliver strategic solutions. I am excited to bring my versatile background in Industrial Engineering, Supply Chain Optimization, and business analytics to a leadership role that challenges and expands my expertise.
                        Feel free to connect with me for opportunities to collaborate on pioneering projects in Supply Chain and technology.
                    </p>
                </div>
            </div>
            ...
            <div className="py-5">
                ...
                <div className="flex flex-wrap gap-10 mt-5 j">
